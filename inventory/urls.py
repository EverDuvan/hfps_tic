...
urlpatterns = [
    ...
    path('inventory/equipment/<int:pk>/retire/', views.retire_equipment_view, name='retire_equipment'),
    ...
    path('inventory/peripherals/<int:pk>/retire/', views.retire_peripheral_view, name='retire_peripheral'),
